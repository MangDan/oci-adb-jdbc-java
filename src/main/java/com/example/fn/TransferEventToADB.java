...
public class TransferEventToADB {
    ...
    public String handleRequest(final Event event) {
        if (event.event.equals("health-check"))
            return "Good!!!";
        ...
        try {
            ...
            st.setString(3, System.currentTimeMillis() + "-" + event.event);
            ...
            st.setString(2, System.currentTimeMillis() + "-" + event.properties.property2);
            ...
            if (event.getProperties().propertyarray.size() > 0) {
                for (int i = 0; i < event.getProperties().propertyarray.size(); i++) {
                    st.setString(1,
                            System.currentTimeMillis() + "-" + event.getProperties().propertyarray.get(i).get("key1"));
                    st.setString(2,
                            System.currentTimeMillis() + "-" + event.getProperties().propertyarray.get(i).get("key2"));
                    st.executeUpdate();
                }
            }
